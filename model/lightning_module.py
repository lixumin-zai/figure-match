...
class DINOLightningModule(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        images = batch  # 假设你的数据集返回 (global_views, local_views)
    ...
    #     # 按照 epoch 命名保存教师模型
    #     teacher_model_path = save_path / f"teacher_model_epoch_{current_epoch}.pth"
    #     torch.save(self.teacher.backbone, teacher_model_path)
...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(project="similar-image-dino", log_model=True)
